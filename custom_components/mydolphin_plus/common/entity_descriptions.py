...
ENTITY_DESCRIPTIONS: list[MyDolphinPlusEntityDescription] = [
    ...
    MyDolphinPlusSensorEntityDescription(
        key=slugify(DATA_KEY_NEXT_SCHEDULED_MODE),
        name=DATA_KEY_NEXT_SCHEDULED_MODE,
        icon="mdi:calendar-arrow-right",
        device_class=SensorDeviceClass.ENUM,
        options=[str(mode) for mode in CleanModes],
        translation_key=slugify(DATA_KEY_NEXT_SCHEDULED_MODE),
    ),
    MyDolphinPlusSensorEntityDescription(
        key=slugify(DATA_KEY_NEXT_SCHEDULED_CYCLE_TIME),
        name=DATA_KEY_NEXT_SCHEDULED_CYCLE_TIME,
        icon="mdi:calendar-clock-outline",
        device_class=SensorDeviceClass.DURATION,
        state_class=SensorStateClass.MEASUREMENT,
        native_unit_of_measurement=UnitOfTime.MINUTES,
        translation_key=slugify(DATA_KEY_NEXT_SCHEDULED_CYCLE_TIME),
    ),
    MyDolphinPlusSensorEntityDescription(
